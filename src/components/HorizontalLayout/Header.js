          ...
          <div className="d-flex">
            ...
            >
              <DropdownToggle className="btn header-item waves-effect" caret tag="button">
                {props.t('Choose Topic')} <i className="mdi mdi-chevron-down"></i>
              </DropdownToggle>
              <DropdownMenu className="dropdown-megamenu">
                <Row>
                  <Col sm={8}>
                    <Row>
                      <Col md={4}>
                        <h5 className="font-size-14 mt-0">{props.t('REPRODUCTIVE HEALTH')}</h5>
                      ...
                      <Col md={4}>
                        <h5 className="font-size-14 mt-0">{props.t('Family Planning')}</h5>
                        <ul className="list-unstyled megamenu-list">
                          <li>
                      ...
                      <Col md={4}>
                        <h5 className="font-size-14 mt-0">{props.t('HIV/AIDS & STIs')}</h5>
                        <ul className="list-unstyled megamenu-list">
                          <li>
                  ...
                  <Col sm={4}>
                    <Row>
                      <Col sm={6}>
                        <h5 className="font-size-14 mt-0">{props.t('Menstruation Cycle')}</h5>
                        <ul className="list-unstyled megamenu-list">
                          <li>
                            <Link to="#">{props.t('Lightbox')}</Link>
                          </li>
